...
public class Scooters {
    ...
    public Scooters(WebDriver driver) {
        this.driver = driver;
    }

    //метод ожидания загрузки страницы
    public Scooters waitAboutRentHeader() {
    ...
    public Scooters inputDate(String newDate) {
        driver.findElement(date).sendKeys(newDate);
        return this;
    }

    public Scooters inputDuration(String newDuration) {
    ...
    public Scooters changeColour(Enum colour) {
    ...
    public Scooters inputComment(String newComment) {
